...
api_patterns = [
    ...
    url(
        r"^workflowjob/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^job/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
        JobDetail.as_view(),
        name="job-detail",
    ),
    ...
    url(
        r"^workflowrun/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
        WorkflowRunDetail.as_view(),
        name="workflowrun-detail",
    ),
    url(r"^runjobs/$", RunJobList.as_view(), name="runjob-list"),
    url(
        r"^runjob/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^connection/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^outputport/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^inputport/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
        InputPortDetail.as_view(),
        name="inputport-detail",
    ),
    url(r"^resources/$", ResourceList.as_view(), name="resource-list"),
    url(
        r"^resource/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^resourcelist/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
        ResourceListDetail.as_view(),
        name="resourcelist-detail",
    ),
    url(r"^resourcetypes/$", ResourceTypeList.as_view(), name="resourcetype-list"),
    url(
        r"^resourcetype/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
    ...
    url(
        r"^input/(?P<pk>[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12})/$",
        InputDetail.as_view(),
        name="input-detail",
    ),
    url(
    ...
    url(
        r"^workflowjobgroupcoordinatesets/$",
